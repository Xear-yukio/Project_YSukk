...
@section('title', 'Login - Belanja.ID')
@section('meta_description', 'Login ke akun Belanja.ID Anda untuk mulai berbelanja.')
...
<style>
    ...
    .auth-form-wrapper {
        flex: 1; padding: 56px 48px; display: flex;
    ...
    .checkbox-container {
        display: flex; align-items: center; gap: 8px; font-size: 13.5px; color: var(--text-sub); font-weight: 500; cursor: pointer;
    }
    .checkbox-container input { width: 18px; height: 18px; accent-color: var(--primary); cursor: pointer; }
    .forgot-link { font-size: 13.5px; color: var(--primary); font-weight: 600; text-decoration: none; transition: 0.2s;}
    ...
    .auth-divider {
        display: flex; align-items: center; gap: 16px; margin: 32px 0; color: #94a3b8; font-size: 12px; font-weight: 600; text-transform: uppercase;
    }
    ...
    .alert-success {
        background: #ecfdf5; color: #059669; padding: 16px; border-radius: var(--radius-md);
        font-size: 14px; font-weight: 600; margin-bottom: 24px; border: 1px solid #10b981;
    }

    @media (max-width: 900px) { .auth-banner { display: none; } .auth-container { max-width: 480px; } }
    @media (max-width: 480px) { .auth-form-wrapper { padding: 40px 24px; } .social-login { flex-direction: column; } }
</style>
@endpush
    ...
    <div class="auth-container">
        ...
        <div class="auth-banner">
            <div class="auth-banner-content">
                <div class="banner-icon"><i class="fas fa-gem"></i></div>
                <h2>Selamat Datang<br>Kembali!</h2>
                <p>Login ke akun Anda dan nikmati kembali pengalaman belanja terbaik khusus untuk Anda.</p>
            </div>
        </div>
        ...
        <div class="auth-form-wrapper">
            <div class="auth-form-header">
                <h1>Masuk Akun</h1>
                <p>Belum bergabung? <a href="{{ route('register') }}">Buat akun gratis</a></p>
            </div>
            ...
            <div class="auth-divider">Atau masuk cepat dengan</div>
